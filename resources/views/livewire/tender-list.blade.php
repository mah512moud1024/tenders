        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Available Tenders</h1>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            Browse through our available projects and submit your quotes
                        </p>
                    </div>
                    <div class="flex items-center space-x-3">
                        <div class="text-sm text-gray-500 dark:text-gray-400">
                            Showing {{ $tenders->firstItem() ?? 0 }} to {{ $tenders->lastItem() ?? 0 }} of {{ $tenders->total() }} results
                        </div>
                        <button
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 mb-6">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-xs text-gray-500 dark:text-gray-400">
                                Sorted by: {{ $sortBys === 'created_at' ? 'Newest' : 'Closing Date' }}
                                ...
                                <div class="p-6">
                                    <div class="flex justify-between items-start mb-4">
                                        ...
                                        <div class="text-right ml-4">
                                            <div class="text-sm text-gray-500 dark:text-gray-400 mb-1">Closing Date</div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 text-sm">
                                        @if($tender->building_area)
                                            <div class="flex items-center text-gray-600 dark:text-gray-400">
                                                ...
                                                <span>{{ $tender->building_area }} m² Building Area</span>
                                            </div>
                                        @endif
                                        ...
                                        @if($tender->land_area)
                                            <div class="flex items-center text-gray-600 dark:text-gray-400">
                                                ...
                                                <span>{{ $tender->land_area }} m² Land Area</span>
                                            </div>
                                        @endif
                                        ...
                                        @if($tender->floors)
                                            <div class="flex items-center text-gray-600 dark:text-gray-400">
                                                ...
                                                <span>{{ $tender->floors }} Floors</span>
                                            </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="flex justify-between items-center pt-4 border-t border-gray-200 dark:border-gray-700">
                                        <div class="text-sm text-gray-500 dark:text-gray-400">
                                            Posted by: <span class="font-medium text-gray-700 dark:text-gray-300">{{ $tender->user->business_name ?? $tender->user->full_name }}</span>
                                        </div>
